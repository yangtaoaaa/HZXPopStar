...
- (id)initWithFrame:(CGRect)frame{
    if(self = [super initWithFrame:frame]){
        ...
        [self setTitleColor:HZXColor(163, 163, 163, 1) forState:UIControlStateNormal];
        [self setTitleColor:HZXColor(163, 163, 163, 1) forState:UIControlStateSelected];
...
//    self.imageView.centerX = self.centerX;
    ...
    self.imageView.height = self.height * (1 - kTitleRatio) - 2;
    // text 居中并设置frame
